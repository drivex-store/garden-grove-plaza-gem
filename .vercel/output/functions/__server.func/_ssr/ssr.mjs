...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-_5hAMq5W.mjs");
...
var manifest = { "fc7cbc73f083660068a23073a59e9b01ff7605201087ab23ca54dc1365e1ed48": {
	functionName: "runRefactor_createServerFn_handler",
	importer: () => import("./ai-CWCjPFvU.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DbdCmhyC.mjs").then((n) => n.t),
