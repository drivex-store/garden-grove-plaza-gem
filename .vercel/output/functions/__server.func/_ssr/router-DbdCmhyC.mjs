...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DbdCmhyC.js
...
function Toaster$1(props) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
		...
		toastOptions: { classNames: {
			toast: "group toast bg-background-muted text-foreground border-border shadow-[var(--shadow-border)]",
...
var styles_default = "/assets/styles-DXUrDvCc.css";
var APP_NAME = "Splitter Studio";
var THEME_BOOT = `(function(){try{var r=localStorage.getItem("splitter-studio-v1");var t="dark";if(r){var j=JSON.parse(r);if(j&&j.state&&j.state.theme)t=j.state.theme;}document.documentElement.setAttribute("data-theme",t);}catch(e){document.documentElement.setAttribute("data-theme","dark");}})();`;
...
var $$splitComponentImporter = () => import("./routes-BfxQL5fp.mjs");
...
//#endregion
export { dirFromPath as a, fileNameFromPath as c, joinPath as d, splitPath as f, countLines as i, formatBytes as l, byteSize as n, downloadBlob as o, uid as p, cn as r, downloadText as s, router_exports as t, formatNumber as u };
